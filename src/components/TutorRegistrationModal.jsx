...
export default function TutorRegistrationModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-[#0c311e]/60 backdrop-blur-md animate-in fade-in duration-200">
      <div
        className="w-full max-w-xl max-h-[94dvh] sm:max-h-[90dvh] flex flex-col rounded-t-[28px] sm:rounded-3xl bg-white border-t-2 sm:border-2 border-[#d4a359]/60 shadow-2xl text-[#1a3325] relative overflow-hidden"
        role="dialog"
        aria-modal="true"
      >
        {/* Top Gold Accent Bar */}
